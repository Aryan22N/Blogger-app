...
export const FetchCategoray = createAsyncThunk(
    ...
    async (arg, { rejectWithValue }) => {
        try {
            ...
            const response = await axios.get(`${process.env.REACT_APP_API_URL}/category/catlist`)
...
export const UpdateCategoray = createAsyncThunk(
    ...
    async ({id,CatData}, { rejectWithValue }) => {
        ...
        try {
            const response = await axios({
                method: 'put',
                url: `${process.env.REACT_APP_API_URL}/category/updatecat/${id}`,
                data: CatData,
                headers: {
                    token: localStorage.getItem('token'),
                },
...
export const DeleteCategoray = createAsyncThunk(
    ...
    async (catId, { rejectWithValue }) => {
        try {
            const response = await axios({
                method: 'delete',
                url: `${process.env.REACT_APP_API_URL}/category/deletecat/${catId}`,
                headers: {
                    token: localStorage.getItem('token'),
                },
            })
