...
export const fetchAuthor = createAsyncThunk(
    ...
    async (arg, { rejectWithValue }) => {
        try {
            const response = await axios.get(`${process.env.REACT_APP_API_URL}/author/authlist`);
...
export const AddAuthorData = createAsyncThunk(
    ...
    async (addAuthorInputData, { rejectWithValue }) => {
        ...
        try {
            const response = await axios.post(`${process.env.REACT_APP_API_URL}/author/addAuth`, addAuthorInputData, {
                headers: {
...
export const DeleteAuthor = createAsyncThunk(
    ...
    async (autID, { rejectWithValue }) => {
        try {
            const response = await axios.delete(`${process.env.REACT_APP_API_URL}/author/deleteAuth/${autID}`, {
                headers: {
                    token: localStorage.getItem('token'),
                },
            });
...
export const UpdateAuthor = createAsyncThunk(
    ...
    async ({ID,Data}, { rejectWithValue }) => {
        try {
            const response = await axios.put(`${process.env.REACT_APP_API_URL}/author/updateAuth/${ID}`, Data, {
                headers: {
                    token: localStorage.getItem('token'),
                },
            });
